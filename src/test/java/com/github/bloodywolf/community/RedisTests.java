...
public class RedisTests {
    ...
    public void testSets() {
        ...
        redisTemplate.opsForSet().add(redisKey, "aaa", "bbb", "cccc", "dddd");
    ...
    public void testSortedSets() {
        ...
        redisTemplate.opsForZSet().add(redisKey, "aaa", 11);
        redisTemplate.opsForZSet().add(redisKey, "bbb", 22);
        redisTemplate.opsForZSet().add(redisKey, "ccc", 66);
        redisTemplate.opsForZSet().add(redisKey, "ddd", 44);
        redisTemplate.opsForZSet().add(redisKey, "eee", 99);
    ...
    public void testTransactional(){
        Object obj = redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations redisOperations) throws DataAccessException {
                ...
                redisOperations.opsForSet().add(redisKey,"ddd");
