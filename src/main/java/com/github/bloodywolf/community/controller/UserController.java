package com.github.bloodywolf.community.controller;

import com.github.bloodywolf.community.annotation.LoginRequired;
import com.github.bloodywolf.community.entity.User;
import com.github.bloodywolf.community.service.FollowService;
import com.github.bloodywolf.community.service.LikeService;
import com.github.bloodywolf.community.service.UserService;
import com.github.bloodywolf.community.util.CommunityConstant;
import com.github.bloodywolf.community.util.CommunityUtil;
import com.github.bloodywolf.community.util.HostHolder;
...
public class UserController implements CommunityConstant {
    ...
    public String uploadHeader(MultipartFile headerImage, Model model) {
        ...
        // 生成随机文件名
        fileName = CommunityUtil.generateUUID().substring(0, 5) + System.currentTimeMillis() + suffix;
        // 确认文件存放的路径
    ...
    public String updatePassword(String oldPassword, String newPassword, String confirmPassword,
        ...
        // 验证两次密码是否相同
        if (newPassword == null) {
            model.addAttribute("newPasswordMsg", "请输入密码!");
            return "/site/setting";
        }
